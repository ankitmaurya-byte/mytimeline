  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        <div
          className={cn(
            "flex flex-row justify-start gap-4 pl-4 relative",
      ...
      <div className="flex justify-end gap-2 mr-10 relative">
        <button
        ...
        >
          <ArrowRightCircle className="h-6 w-6 text-gray-500" />
        </button>
      </div>
    </div>
  );
...
export const Card = ({ card }: { card: CardData }) => {
  return (
    <motion.button className="rounded-3xl border bg-gray-100 dark:bg-neutral-900 h-60 md:h-[30rem] w-[20rem] md:w-[50rem] overflow-hidden flex flex-col items-start justify-start relative z-10">
...
export const BlurImage = ({
  ...
  return (
    <img
      ...
      {...rest}
      style={{ objectFit: "cover", width: width || "100%", height: height || "100%" }}
    />
  );
};
